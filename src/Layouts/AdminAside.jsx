    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#vehicles-nav" data-bs-toggle="collapse" href="/">
          ...
          <span>Vehicles</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="vehicles-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="VehiclesBus">
              <i class="bi bi-circle"></i><span>Bus</span>
            </a>
          </li>
        </ul>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#hires-nav" data-bs-toggle="collapse" href="/">
          <i class="bi bi-geo"></i>
          <span>Hires</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="hires-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="HiresCar">
              <i class="bi bi-circle"></i><span>Car</span>
            </a>
