...
const Booking = () => {
  return (
    <>
      <button class="mb-4 btn btn-primary shadow-sm text-white fw-bold theme-bg-blue" data-bs-toggle="modal" data-bs-target="#Booking"><i class="bi bi bi-book"></i> Book Now </button>
