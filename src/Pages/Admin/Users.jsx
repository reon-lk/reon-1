          ...
          <tbody>
            <tr>
              ...
              <td class="d-flex align-items-center justify-content-between">
                <a href="user-details.html?uid=2434"><button type="button" class="btn btn-success">Details <i class="bi bi-file-person"></i></button></a>
            ...
            <tr>
              ...
              <td><span class="badge bg-success">Active</span></td>
              <td class="d-flex align-items-center justify-content-between">
                <a href="user-details.html?uid=2458"><button type="button" class="btn btn-success">Details <i class="bi bi-file-person"></i></button></a>
            ...
            <tr>
              ...
              <td class="d-flex align-items-center justify-content-between">
                <a href="/"><button type="button" class="btn btn-success">Details <i class="bi bi-file-person"></i></button></a>
                <button type="button" class="btn btn-warning theme-bg-orange">Edit <i class="bi bi-pencil-square"></i></button>
                <button type="button" class="btn btn-danger">Delete <i class="bi bi-trash"></i></button>
              </td>
            </tr>
