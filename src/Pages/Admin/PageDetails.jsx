  ...
  <div class="row">
    ...
    <div class="card">
        ...
        <table class="table mt-3">
          <tbody>
            ...
            <tr>
              ...
              <td>User Name 1</td>
              <td class="col-sm-8"><a href="user-details.html?uid=2434" target="_blank"><button type="button" class="btn btn-primary theme-bg-blue">User Details <i class="ri-external-link-fill"></i></button></a></td>
            </tr>
            <tr>
              <th scope="row" class="col-sm-2">No of Vehicles</th>
              <td>3</td>
              <td class="col-sm-8"><a href="user-details.html?uid=2434" target="_blank"><button type="button" class="btn btn-warning theme-bg-orange">Vehicle Details <i class="ri-external-link-fill"></i></button></a></td>
            </tr>
            <tr>
              <th scope="row" class="col-sm-2">No of Hires</th>
              <td>27</td>
              <td class="col-sm-8"><a href="hire-details.html?pid=3043" target="_blank"><button type="button" class="btn btn-primary theme-bg-blue">Hire Details <i class="ri-external-link-fill"></i></button></a></td>
            </tr>
          </tbody>
        </table>
        {/* <!-- End Page Details --> */}
      ...
      <div class="card-footer">
        <a href="pages.html"><button type="button" class="mx-2 btn btn-secondary"><i class="bi bi-chevron-double-left"></i> Back</button></a>
