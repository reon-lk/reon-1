          ...
          <tbody>
            <tr>
              ...
              <td class="d-flex align-items-center justify-content-between">
                <a href="HireDetails"><button type="button" class="btn btn-primary theme-bg-blue">Details <i class="bi bi-receipt-cutoff"></i></button></a>
              </td>
            </tr>
            <tr>
              <td>2</td>
              ...
              <td class="d-flex align-items-center justify-content-between">
                <a href="hire.html?hid=10983"><button type="button" class="btn btn-primary theme-bg-blue">Details <i class="bi bi-receipt-cutoff"></i></button></a>
              </td>
            </tr>
            <tr>
              <td>3</td>
