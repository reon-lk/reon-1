...
<div class="pagetitle">
  ...
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="/VehiclesCar"><i class="bi bi-house-door"></i></a></li>
      <li class="breadcrumb-item active">Vehicles-Car</li>
    </ol>
  </nav>
</div>
{/* <!-- End Page Title --> */}
          ...
          <tbody>
            <tr>
              ...
              <td class="d-flex align-items-center justify-content-between">
                <a href="VehicleDetails"><button type="button" class="btn btn-success">Details <i class="bi bi-front"></i></button></a>
