...
const Aside = () => {
  return (
    ...
    <ul className="sidebar-nav" id="sidebar-nav">
      ...
      <li className="nav-item">
        <a className="nav-link collapsed" data-bs-target="#vehicles-nav" data-bs-toggle="collapse" href="#">
          <i className="bi bi-car-front"></i>
          <span>Vehicles</span><i className="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="vehicles-nav" className="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="vehicles-car">
      ...
      <li className="nav-item">
        <a className="nav-link collapsed" data-bs-target="#hires-nav" data-bs-toggle="collapse" href="#">
          <i className="bi bi-geo"></i>
          <span>Hires</span><i className="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="hires-nav" className="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="hires-car">
              <i className="bi bi-circle"></i><span>Car</span>
            </a>
      ...
      <li className="nav-item">
        <a className="nav-link collapsed" href="pageSettings">
